...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        # Set up the enemy
        enemy_image = arcade.Sprite(":resources:images/animated_characters/zombie/zombie_idle.png",
                                    ENEMY_SCALING)
        enemy_image.center_x = 700
        enemy_image.center_y = 96
        self.enemy_list.append(enemy_image)
